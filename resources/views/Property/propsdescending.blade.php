...
<div class="site-blocks-cover inner-page-cover overlay" style="background-image: url({{asset('assets/images/hero_bg_2.jpg')}});" data-aos="fade" >
    <div class="container">
      <div class="row align-items-center justify-content-center text-center">
        <div class="col-md-10">
          <h1 class="mb-2">properties in price descending order</h1>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-12">
          <div class="site-section-title mb-5">
            <h2>properties in price descending order</h2>
          </div>
        </div>
      </div>
    
      <div class="row mb-5">
        @if ($propertypricedesc->count()>0)
        @foreach ($propertypricedesc as $buyprop )
       ...
       <p class="alert alert-success">No property is found</p>
