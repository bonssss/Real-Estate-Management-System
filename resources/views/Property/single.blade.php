        ...
        <div class="col-lg-8">
          <div>
            <div class="slide-one-item home-slider owl-carousel">
              ...
              <div><img src="{{asset('assets/postimages/'.$propimages->image.'')}}" alt="Image" class="img-fluid"></div>
          ...
          <div class="bg-white property-body border-bottom border-left border-right">
            ...
            <div class="row no-gutters mt-5">
              <div class="col-12">
                ...
                <a href="{{asset('assets/postimages/'.$propimages->image.'')}}" class="image-popup gal-item"><img src="{{asset('assets/postimages/'.$propimages->image.'')}}" alt="Image" class="img-fluid"></a>
