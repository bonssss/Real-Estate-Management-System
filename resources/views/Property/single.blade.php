                    ...
                    <div>
                        <div class="slide-one-item home-slider owl-carousel">
                            @foreach ($propertyimages as $propimages)
                                <div><img src="{{ asset('assets/images/' . $propimages->image . '') }}" alt="Image"
                                        class="img-fluid"></div>
                            @endforeach
                            ...
                            @foreach ($propertyimages as $propimages)
                                <div class="col-sm-6 col-md-4 col-lg-3">
                                    ...
                                    @if (file_exists(public_path('assets/images/' . $propimages->image)))
                                        ...
                                        <a href="{{ asset('assets/images/' . $propimages->image) }}"
                                            class="image-popup gal-item">
                                            <img src="{{ asset('assets/images/' . $propimages->image) }}" alt="Image"
                                                class="img-fluid">
                                        </a>
                                    @else
                                        ...
                                        <a href="{{ asset('assets/postimages/' . $propimages->image) }}"
                                            class="image-popup gal-item">
                                            <img src="{{ asset('assets/postimages/' . $propimages->image) }}"
